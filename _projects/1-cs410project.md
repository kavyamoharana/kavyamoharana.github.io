...
{% include elements/button.html link="https://github.com/kavyamoharana/kavyamoharana.github.io/blob/main/assets/pdfs/410-Report.docx.pdf" text="View Full Report" size="sm" %}
{% include elements/button.html link="https://github.com/kavyamoharana/kavyamoharana.github.io/blob/main/python_notebooks/CS410-Project.ipynb" text="The Analysis (Jupyter Notebook)" size="sm" %}
